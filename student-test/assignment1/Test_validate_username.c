...
void test_validate_my_username()
{
     ...
     */
    char* const actual_user_name = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(), actual_user_name, "User name");
    free(actual_user_name);
}
